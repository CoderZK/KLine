...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        self.placeHolderLB = [[UILabel alloc] initWithFrame:self.bounds];
        [self addSubview:self.placeHolderLB];
        self.placeHolderLB.font =[UIFont systemFontOfSize:14];
        self.placeHolderLB.textColor =[UIColor colorWithDisplayP3Red:200/255.0 green:200/255.0 blue:200/255.0 alpha:200/255.0];
