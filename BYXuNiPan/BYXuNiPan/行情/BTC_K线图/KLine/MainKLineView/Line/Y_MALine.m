...
//        CGContextAddLineToPoint(self.context, point.x, point.y);
//    }
//    CGContextAddLineToPoint(self.context, lastPoint.x, CGRectGetMaxY(self.frame));
//    CGContextAddLineToPoint(self.context, firstPoint.x, CGRectGetMaxY(self.frame));
//    CGContextClosePath(self.context);
//    CGContextFillPath(self.context);
    
}

- (void)drawWith:(UIView *)view
{
    if(!self.context)
    {
        return;
    ...
    CGContextStrokePath(self.context);
         ...
         CGPoint firstPoint = [self.MAPositions.firstObject CGPointValue];
        CGContextSetFillColorWithColor(self.context, [UIColor timeLineVolumeLineFillColor].CGColor);
        CGPoint lastPoint = [self.MAPositions.lastObject CGPointValue];
        ...
        CGContextAddLineToPoint(self.context, lastPoint.x, CGRectGetMaxY(view.frame));
        CGContextAddLineToPoint(self.context, firstPoint.x, CGRectGetMaxY(view.frame));
        CGContextClosePath(self.context);
        CGContextFillPath(self.context);
